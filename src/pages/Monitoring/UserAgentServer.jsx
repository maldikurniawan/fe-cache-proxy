...
import { set_id_server } from '@/redux/useragentSlice'; // Correctly import the action
import { API_URL_getserver } from '@/constants';

const UserAgentServer = () => {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const { id_server } = useSelector((state) => state.useragent);
...
export default UserAgentServer;
